        ...
        {sent ? (
          ...
          <form onSubmit={handleSignup} className="space-y-5">
            ...
            <button
              ...
              className="flex items-center justify-center gap-3 w-full border border-gray-200 rounded-lg px-4 py-3 text-sm font-medium text-charcoal hover:border-primary hover:bg-warm-white transition-colors disabled:opacity-40 disabled:cursor-not-allowed min-h-[44px]"
            >
            ...
            <div className="space-y-3 pt-1">
              <label className="flex items-start gap-3 cursor-pointer">
                <input
                  ...
                  className="mt-0.5 accent-primary w-5 h-5 shrink-0"
                />
