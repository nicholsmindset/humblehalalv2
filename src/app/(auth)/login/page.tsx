        ...
        {sent ? (
          ...
          <div className="space-y-6">
            ...
            <button
              ...
              className="flex items-center justify-center gap-3 w-full border border-gray-200 rounded-lg px-4 py-3 text-sm font-medium text-charcoal hover:border-primary hover:bg-warm-white transition-colors"
            >
              {/* Google icon (SVG) */}
